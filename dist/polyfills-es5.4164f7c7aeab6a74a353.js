            ...
            function (t, r) {
              ...
              for (var x, w = '', _ = 0, T = 0; T < E.length; T++) {
                ...
                for (
                  ...
                  j.push(void 0 === (x = S[D]) ? x : String(x));
                var P = S.groups;
                if (v) {
                  var R = [O].concat(j, I, h);
                  void 0 !== P && R.push(P);
                  var M = String(r.apply(void 0, R));
                } else M = m(O, h, I, j, P, r);
                ...
                if ((!E || x) && !Zone[t.symbol('patchEvents')]) {
                  ...
                  if (S) {
                    ...
                    at(
                      ...
                      at(HTMLMediaElement.prototype, X, r),
                      at(HTMLFrameSetElement.prototype, q.concat(Q), r),
                      at(HTMLBodyElement.prototype, q.concat(Q), r),
      ...
      pNMO: function (t, e, n) {
        ...
        var r = n('I+eb'),
          ...
          ut = function (t) {
            ...
            return (
              !(this === G && l(X, e) && !l(J, e)) &&
              (!(n || !l(this, e) || !l(X, e) || (l(this, F) && this[F][e])) ||
                n)
            );
          },
          st = function (t, e) {
