        ...
        class t {
          ...
          getCartId(t) {
            return this.httpClient
              .get(((t) => 'http://localhost:3000/api/pesanans/' + t)(t))
              .pipe(
                Object(o.a)((t) => t),
                Object(s.a)((t) => Object(b.a)(t))
              );
          }
          deleteCartId(t) {
            return this.httpClient
              .delete(((t) => 'http://localhost:3000/api/pesanan/' + t)(t))
              .pipe(
                Object(o.a)((t) => t),
                Object(s.a)((t) => Object(b.a)(t))
              );
          ...
          UpdateCartId(t, c) {
            return this.httpClient
              .put(((t) => 'http://localhost:3000/api/pesanan/' + t)(t), c)
              .pipe(
                Object(o.a)((t) => t),
                Object(s.a)((t) => Object(b.a)(t))
              );
          ...
          PostCheckoutId(t, c) {
            return (
              console.log('data', c),
              this.httpClient
                .post(((t) => 'http://localhost:3000/api/detail/' + t)(t), c)
                .pipe(
                  Object(o.a)((t) => t),
                  Object(s.a)((t) => Object(b.a)(t))
                )
      ...
      const P = [
        {
          ...
          component: (() => {
            ...
            return (
              (t.ɵfac = function (c) {
                return new (c || t)(d.Kb(l), d.Kb(r.e));
              }),
              (t.ɵcmp = d.Eb({
                type: t,
                selectors: [['app-cart']],
                ...
                directives: [n.j, p.j, p.a, p.e, p.h],
                styles: [''],
              })),
              t
            );
          })(),
          data: { title: Object(i.a)('Cart') },
        },
      ];
      let f = (() => {
          class t {}
